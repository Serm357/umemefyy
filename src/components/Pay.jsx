                  ...
                  >
                    <span className="flex me-5">
                      ...
                      <span className="ms-5">
                        ...
                        <span className="block text-sm text-gray-500">
                          Get an email when a Preline Meetup is posted close to
                          my location
                        </span>
                      </span>
                    </span>
                ...
                <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
                  ...
                  >
                    <span className="flex me-5">
                      ...
                      <span className="ms-5">
                        <span className="block font-medium text-gray-800 dark:text-gray-200">
                          Preline Communication
                        </span>
                        <span className="block text-sm text-gray-500">
                          Get Preline news, announcements, and product updates
                        </span>
                      </span>
                    </span>
