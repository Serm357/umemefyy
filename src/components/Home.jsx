    ...
    <>
      ...
      <section className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="block text-3xl font-bold text-headingColor sm:text-4xl lg:text-6xl lg:leading-tight dark:text-headingColor">
              Rahisisha maisha kwa kutumia{" "}
              <span className="blue-text-gradient">Umemefyy</span>
            </h1>
            <p className="mt-3 text-lg text-primaryColor dark:text-primaryColor">
              Suluhisho bora na jepesi kuhusu matumizi yako ya umeme . Rahisisha
              mahesabu magumu ya umeme bila hitilafu
            </p>
          ...
          <div className="relative ms-4">
            ...
            <div className="absolute bottom-0 start-0">
              <svg
                className="w-2/3 ms-auto h-auto text-primaryColor dark:text-primaryColor"
                width="630"
                height="451"
                viewBox="0 0 630 451"
                fill="none"
